...
export function App() {
  ...
  const resume: Resume = {
    ...
    projects: [
      ...
      },
      {
        ...
        image: 'https://camo.githubusercontent.com/9b3aca7f11bf6c7a43ee69241c615c3269057b02ae973e6a7907593dfdaa3faf/68747470733a2f2f692e696d6775722e636f6d2f394536777436622e706e67',
      ...
      },
      {
        ...
        links: [{ label: source, url: 'https://github.com/GorkyR/AutoServicioUASD' }],
      },
      {
        ...
        links: [
          { label: swx(language, { en: 'Online resume', es: 'Curriculum online' }), url: 'https://gorkyr.github.io/resume' },
  ...
  const content = (printing?: boolean) => <Template1 resume={resume} language={language} printing={printing}/>
  ...
  return <div className="relative">
    ...
    <div className="fixed top-0 right-0 grid place-items-start gap-1 text-xs p-2">
      <button
        ...
        <Icon icon="language"/> {swx(language, { en: 'Language', es: 'Lenguaje' })} (l): {swx(language, { en: '[en] es', es: 'en [es]' })}
      </button>
      <button
        onClick={() => print(content(true))} 
        className="border rounded px-2 py-1 bg-white hover:bg-neutral-100">
        <Icon icon="print"/> {swx(language, { en: 'Print', es: 'Imprimir' })} (p)
      </button>
    </div>
  </div>
}